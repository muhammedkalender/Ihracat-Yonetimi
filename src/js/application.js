...
================================================== */
	...
	oTable = $('.datatable table').dataTable({
		...
		"oLanguage": {
			"sSearch": "_INPUT_",
			"sLengthMenu": "_MENU_",
			"oPaginate": { "sFirst": "İlk sayfa", "sLast": "Son sayfa", "sNext": ">", "sPrevious": "<" }
		}
    });
	...
	oTable = $('.datatable-pager table').dataTable({
		...
		"oLanguage": {
			"sSearch": "<span>Filter:</span> _INPUT_",
			"sLengthMenu": "<span>Kayıtları Göster:</span> _MENU_",
	...
	$('.dataTables_filter input[type=text]').attr('placeholder','Arama Yap...');
