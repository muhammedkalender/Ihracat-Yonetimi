...
"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"İlk",sLast:"Son",sNext:"Sonraki",sPrevious:"Önceki"},sEmptyTable:"Veri Yok",sInfo:"Kayıt _START_ - _END_ | Toplam: _TOTAL_ ",sInfoEmpty:"Sayfa 0 - 0 ",
sInfoFiltered:"(Toplam Kayıt _MAX_)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Liste Gösterim Sayısı _MENU_ ",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Filitrele: ",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Kayıt Bulunamadı"},oSearch:h.extend({},m.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};
